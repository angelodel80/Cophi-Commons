...
public abstract class DiffProvider extends Object {
     ...
     */
    // GESTIRE GRANULARITA E TRASPOSIZIONE PER GLI ALLINEAMENTI
    public abstract Variant[] computeDiff(Reader r1, Reader r2) throws IOException;
}
