...
import eu.cophi.util.lookup.Lookup;
...
public abstract class Diff extends Object {
    ...
    public abstract static class DiffInfo {

        abstract public Reader createFirstReader();

        abstract public Reader createSecondReader();

        abstract public void setInitialDiffs(Variant[] diffs);

        abstract public Variant[] getInitialDifferences();
    }
    
    public abstract DiffInfo createDiff(String name1, String title1,
...
//    }
     ...
     * @return The Component representing the diff visual representation or
     * null, when the representation is outside the IDE.
...
//    
    /**
     * Creates single-window diff component that does not include any navigation
     * controls and is controlled programatically via the returned DiffView
     * interface. <p> The StreamSource can be used to save the source content if
     * it's modified in the view. The view should not allow source modification
     * if StreamSource.createWriter() returns
     * <code>null</code>.
     *
