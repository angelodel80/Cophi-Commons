...
public class Variant extends Object implements Serializable {
    ...
    private Variant.Part[] firstLineDiffs;
    private Variant.Part[] secondLineDiffs;
     ...
     */
    public Variant(int type, int firstStart, int firstEnd, int secondStart, int secondEnd) {
     ...
     */
    public Variant(int type, int firstStart, int firstEnd, int secondStart, int secondEnd,
                      String firstText, String secondText, Variant.Part[] firstLineDiffs, Variant.Part[] secondLineDiffs) {
        if (type > 2 || type < 0) {
     ...
     * Can be <code>null</code> when there are no line differences.
     */
    public Variant.Part[] getFirstLineDiffs() {
     ...
     * Can be <code>null</code> when there are no line differences.
     */
    public Variant.Part[] getSecondLineDiffs() {
    ...
    public String toString() {
        return "Variant is "+((type == ADD) ? "ADD" : (type == DELETE) ? "DELETE" : "CHANGE")+", "+
               "starting at line [first file] "+firstStart+", and ending at line [firt file] "+firstEnd+", starting at line [second file] "+secondStart+", and ending at line [second file] "+secondEnd+")";
    }
