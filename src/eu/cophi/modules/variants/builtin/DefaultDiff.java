...
import eu.cophi.api.variants.*;
import eu.cophi.spi.variants.*;
...
public class DefaultDiff extends Diff implements Serializable {
     ...
     */
    public Diff.DiffInfo createDiff(String name1, String title1, Reader r1,
        ...
        Diff.DiffInfo diffInfo = new DiffInfoImpl(name1, name2, title1, title2,
        ...
        try {
            Variant[] diffs = provider.computeDiff(diffInfo.createFirstReader(), diffInfo.createSecondReader());
...
//    }
    ...
    // controllare le regole di accesso: la classe DiffInfoImple è privata, mentre la classe Diff.DiffInfo è pubblica
    private static class DiffInfoImpl extends Diff.DiffInfo{
        
        private String buffer1, buffer2;
        private Variant[] diffs;
        
        public DiffInfoImpl(String name1, String name2, String title1, String title2,
        ...
        @Override
        public Variant[] getInitialDifferences() {
            Variant[] diffs = this.diffs;
           // this.diffs = null;
            return diffs;
        }

        @Override
        public void setInitialDiffs(Variant[] diffs) {
