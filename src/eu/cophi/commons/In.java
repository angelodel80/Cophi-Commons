/**
 * ***********************************************************************
 * Wrapper from In.java from princeton 
 *
 * Reads in data of various types from input.
 *
 ************************************************************************
 */
package eu.cophi.commons;
 ...
 * from standard input, file input, URLs, and sockets. <p> The Locale used is:
 * language = English, country = US. This is consistent with the formatting
 * conventions with Java floating-point literals, command-line arguments (via
 * {@link Double#parseDouble(String)}) and standard output. <p> For additional
 * documentation, see <a
 * href="http://introcs.cs.princeton.edu/31datatype">Section 3.1</a> of
 * <i>Introduction to Programming in Java: An Interdisciplinary Approach</i> by
 * Robert Sedgewick and Kevin Wayne. <p> Like {@link Scanner}, reading a token
 * also consumes preceding Java whitespace, reading a full line consumes the
 * following end-of-line delimeter, while reading a character consumes nothing
 * extra. <p> Whitespace is defined in {@link Character#isWhitespace(char)}.
...
public final class In {
    ...
    /**
     * Create an input stream from a given Scanner source; use with <tt>new
     * Scanner(String)</tt> to read from a string. <p> Note that this does not
     * create a defensive copy, so the scanner will be mutated as you read on.
     */
     ...
     * to {@link #readLine()} will succeed. <p> Functionally equivalent to
     * {@link #hasNextChar()}.
     */
     ...
     * next call to {@link #readChar()} will succeed. <p> Functionally
     ...
     *
     * @deprecated Clearer to use <tt>new
     * In(filename)</tt>.{@link #readAllInts()}
     */
     ...
     *
     * @deprecated Clearer to use <tt>new
     * In(filename)</tt>.{@link #readAllDoubles()}
     */
     ...
     *
     * @deprecated Clearer to use <tt>new
     * In(filename)</tt>.{@link #readAllStrings()}
     */
